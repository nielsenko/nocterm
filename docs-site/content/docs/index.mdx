...
> **Note**: Nocterm is in active development (version 0.4.2). While APIs are stabilizing, some changes may occur in future releases.

## Next steps

- [Installation](/docs/installation) - Add Nocterm to your project
